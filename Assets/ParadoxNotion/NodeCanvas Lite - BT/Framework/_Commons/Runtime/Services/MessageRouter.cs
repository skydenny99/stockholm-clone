...
namespace ParadoxNotion.Services{
			...
			IDragHandler, IScrollHandler, IUpdateSelectedHandler, ISelectHandler, IDeselectHandler, IMoveHandler, ISubmitHandler
	{
		...
		///...
		public void RegisterCallback(string message, System.Action callback){ Internal_RegisterCallback(message, callback); }
		public void RegisterCallback<T>(string message, System.Action<T> callback){ Internal_RegisterCallback(message, callback); }
